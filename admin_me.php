...
// $update_p_id 在這裏的作用就是 鎖定你要 update 的產品
        ...
        <section class="display-product-table">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a href="admin_me.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('Are your sure you want to delete this?');"> <i class="fas fa-trash"></i> Delete </a>
                        <a href="admin_me.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> Update</a> 
                    </td>
                </tr>
